				...
				<div :style='{"padding":"0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","margin":"0","display":"flex","justifyContent":"space-between","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","position":"relative","borderStyle":"solid"}'>
					...
					<div :style='{"minHeight":"560px","padding":"0px","margin":"40px 0 0 0","borderColor":"#eee","background":"#fff","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"1"}'>
						...
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>用户账号：</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>用户姓名：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.yonghuxingming}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>性别：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.xingbie}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>用户电话：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.yonghudianhua}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>身份证号：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
