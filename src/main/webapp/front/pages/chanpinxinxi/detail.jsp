					...
					<div :style='{"minHeight":"560px","padding":"0px","margin":"40px 0 0 0","borderColor":"#eee","background":"#fff","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"1"}'>
						<div :style='{"padding":"0px 0","margin":"0 0 10px","borderColor":"#ddd","alignItems":"center","display":"inline-block","justifyContent":"space-between","borderRadius":"0px","background":"#bccfde","borderWidth":"0px","width":"100%","lineHeight":"50px","borderStyle":"solid","height":"50px"}'>
							...
							<div v-if='storeupFlag' :style='{"cursor":"pointer","border":"0px dashed #fff","padding":"0 20px","margin":"0px 0 0","borderRadius":"0px","textAlign":"right","background":"none","display":"inline-block","width":"50%","lineHeight":"50px","float":"right","height":"50px"}' @click="storeUp()">
								<i class="layui-icon" :style='{"color":"#333","fontSize":"18px"}'>&#xe67a;</i>
								<span :style='{"color":"#333","fontSize":"16px"}'>取消收藏</span>
							</div>
							<div v-if='!storeupFlag' :style='{"cursor":"pointer","border":"0px dashed #fff","padding":"0 20px","margin":"0px 0 0","borderRadius":"0px","textAlign":"right","background":"none","display":"inline-block","width":"50%","lineHeight":"50px","float":"right","height":"50px"}' @click="storeUp()">
								<i class="layui-icon" :style='{"color":"#333","fontSize":"18px"}'>&#xe67b;</i>
								<span :style='{"color":"#333","fontSize":"16px"}'>点我收藏</span>
							</div>
						</div>

						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.price" class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>价格：</div>
							<div :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}'>￥{{Number(detail.price).toFixed(2)}}</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.jf" class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>积分：</div>
							<div :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}'>
								{{detail.jf}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.onelimittimes" class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>单次购买：</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.alllimittimes" class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>库存：</div>
							<div :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
						...
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>产品编号：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.chanpinbianhao}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>产品简介：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.chanpinjianjie}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>产品类型：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.chanpinleixing}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>规格：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.guige}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>生产厂家：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shengchanchangjia}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 1px","borderColor":"#eee","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#6e92af","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>发布时间：</div>
							<div  :style='{"width":"100%","padding":"2px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.fabushijian}}
							</div>
						</div>
						...
						<div class="detail-item" :style='{"padding":"10px 7%","flexWrap":"wrap","background":"none","display":"flex"}'>
							...
							<button  :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#e6eef5","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' @click="addCartTap" type="button" class="layui-btn layui-btn-warm">
								添加到购物车
							</button>
							<button  :style='{"border":"0px solid #b5f0f0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#f7efed","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' @click="buyTap" type="button" class="layui-btn btn-submit">
								立即购买
							</button>
				...
				<div class="layui-tab layui-tab-card" :style='{"padding":"0","boxShadow":"none","margin":"40px 0 0","borderColor":"#e6e6e6","minHeight":"500px","overflow":"hidden","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"100%","fontSize":"16px","borderStyle":"solid","order":"10"}'>
					...
					<div :style='{"padding":"15px","background":"#fff"}' class="layui-tab-content">
						...
						<div class="layui-tab-item layui-show">
							<div v-html="detail.chanpintese"></div>
						</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`chanpinxinxi`);
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
							    ...
							    type:1,
								picture:vue.detail.tupian.split(",")[0],
                                inteltype: vue.detail.chanpinleixing,
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
