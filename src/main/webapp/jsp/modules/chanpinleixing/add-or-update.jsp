...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑产品类型</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>产品类型管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑产品类型</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>产品类型</label>
					<input name="chanpinleixing" id="chanpinleixing" name="chanpinleixing" class="form-control" placeholder="请输入产品类型">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chanpinleixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("chanpinleixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chanpinleixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chanpinleixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("chanpinleixing"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#chanpinleixing").val(ruleForm.chanpinleixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chanpinleixing != null && res.data.chanpinleixing != ''){
						...
						$("#chanpinleixing").val(res.data.chanpinleixing);
						$("#chanpinleixing").attr('readonly','readonly');
					}
				}
			});  
            }
