...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>用户电话</label>
					<input name="yonghudianhua" id="yonghudianhua" name="yonghudianhua" class="form-control" placeholder="请输入用户电话">
				</div>
				<div class="form-item">
					<label>身份证号</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yonghudianhua").val(ruleForm.yonghudianhua);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yonghudianhua != null && res.data.yonghudianhua != ''){

						$("#yonghudianhua").val(res.data.yonghudianhua);
						$("#yonghudianhua").attr('readonly','readonly');
					}
