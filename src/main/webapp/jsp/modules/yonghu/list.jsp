...
<body>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>头像</th>
						<th onclick="sort('yonghudianhua')">用户电话<i id="yonghudianhuaIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yonghudianhuaCell  = document.createElement('td');

						 yonghudianhuaCell.innerHTML = item.yonghudianhua;

			row.appendChild(yonghudianhuaCell);
