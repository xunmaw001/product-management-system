...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看产品信息</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看产品信息</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="chanpinleixing" name="chanpinleixing" class="form-control" v-model="ruleForm.chanpinleixing" readonly>
				</div>
				<div class="form-item">
					<label>规格</label>
				...
				<div class="form-item-file">
					<label>产品简介</label>
					<script id="chanpinjianjieEditor" type="text/plain" style="width:800px;height:230px;"></script>
					<script type="text/javascript">
						//建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
						//相见文档配置属于你自己的编译器
						var chanpinjianjieUe = UE.getEditor('chanpinjianjieEditor', {
						toolbars: [
								[
									'undo', //撤销
									'bold', //加粗
					...
					<input type="hidden" name="chanpinjianjie" id="chanpinjianjie-input">
				</div>
				<div class="form-item-file">
					<label>产品特色</label>
					<script id="chanpinteseEditor" type="text/plain" style="width:800px;height:230px;"></script>
					<script type="text/javascript">
						//建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
						//相见文档配置属于你自己的编译器
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.chanpinjianjie != null && ruleForm.chanpinjianjie != 'null' && ruleForm.chanpinjianjie != ''){
				var mes = '' + ruleForm.chanpinjianjie;
				var chanpinjianjieUeditor = UE.getEditor('chanpinjianjieEditor');
				chanpinjianjieUeditor.ready(function() {
					chanpinjianjieUeditor.setContent(mes);
					chanpinjianjieUeditor.setDisabled('fullscreen');
				});
			}
			if(ruleForm.chanpintese != null && ruleForm.chanpintese != 'null' && ruleForm.chanpintese != ''){
				var mes = '' + ruleForm.chanpintese;
				var chanpinteseUeditor = UE.getEditor('chanpinteseEditor');
				chanpinteseUeditor.ready(function() {
					chanpinteseUeditor.setContent(mes);
					chanpinteseUeditor.setDisabled('fullscreen');
				});
			}
		}  
